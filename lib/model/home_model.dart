class HomeModel {
    ...
    factory HomeModel.fromJson(Map<String, dynamic> json) => HomeModel(
        ...
        heroBanners: json["hero_banners"] == null ? [] : List<HeroBanner>.from(json["hero_banners"]!.map((x) => HeroBanner.fromJson(x))),
        activeCourse: json["active_course"] == null ? null : ActiveCourse.fromJson(json["active_course"]),
        popularCourses: json["popular_courses"] == null ? [] : List<PopularCourse>.from(json["popular_courses"]!.map((x) => PopularCourse.fromJson(x))),
        liveSession: json["live_session"] == null ? null : LiveSession.fromJson(json["live_session"]),
    ...
    Map<String, dynamic> toJson() => {
        "user": user?.toJson(),
        "hero_banners": heroBanners == null ? [] : List<dynamic>.from(heroBanners!.map((x) => x.toJson())),
        "active_course": activeCourse?.toJson(),
        "popular_courses": popularCourses == null ? [] : List<dynamic>.from(popularCourses!.map((x) => x.toJson())),
...
class Community {
    ...
    factory Community.fromJson(Map<String, dynamic> json) => Community(
        ...
        recentActivity: json["recent_activity"] == null ? null : RecentActivity.fromJson(json["recent_activity"]),
        action: json["action"],
    );
...
class RecentActivity {
    ...
    factory RecentActivity.fromJson(Map<String, dynamic> json) => RecentActivity(
        ...
        status: json["status"],
        recentMembers: json["recent_members"] == null ? [] : List<RecentMember>.from(json["recent_members"]!.map((x) => RecentMember.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "recent_posts": recentPosts,
        "status": status,
        "recent_members": recentMembers == null ? [] : List<dynamic>.from(recentMembers!.map((x) => x.toJson())),
    };
}
...
class LiveSession {
    ...
    factory LiveSession.fromJson(Map<String, dynamic> json) => LiveSession(
        ...
        sessionDetails: json["session_details"] == null ? null : SessionDetails.fromJson(json["session_details"]),
        action: json["action"],
    );
...
class PopularCourse {
    ...
    PopularCourse copyWith({
        int? id,
        String? name,
        List<HeroBanner>? courses,
    }) => 
        PopularCourse(
            id: id ?? this.id,
            name: name ?? this.name,
    ...
    factory PopularCourse.fromJson(Map<String, dynamic> json) => PopularCourse(
        id: json["id"],
        name: json["name"],
        courses: json["courses"] == null ? [] : List<HeroBanner>.from(json["courses"]!.map((x) => HeroBanner.fromJson(x))),
    );
